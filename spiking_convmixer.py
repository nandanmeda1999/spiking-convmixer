...
# python3 spiking_convmixer.py --dataset-dir ./ --output-dir ./ --workers 2 -b 50 --device cuda:1 -T 4 --width 256 --depth 8 --kernel-size 9 --patch-size 1 --lr 0.1 --momentum 0.9 --epochs 100 --wd 0
